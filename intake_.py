...
class Claw(Subsystem):
    ...
    def __init__(self, test_mode=False):
        ...
        self._Claw_right: TalonFX = self.__configure_right_side()
        ...
        self._curr_location = ClawPosition.SUBWOOFER_2
...
class SetClaw(Command):
    def __init__(self, Claw: Claw, location: ClawPosition):
        self._location = location

        self._Claw = Claw

        self.addRequirements(self._Claw)

    def initialize(self):
        self._Claw.set_Claw_location(self._location)

    # def execute(self):
    #     self._Claw.move_ramp_to_location()

    def isFinished(self) -> bool:
        return self._Claw.Claw_at_angle()

    def end(self, interrupted: bool):
        self._Claw.stop_Claw_ramp()
