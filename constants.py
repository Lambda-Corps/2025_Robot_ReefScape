...
# The following constants are used to measure the current on the Motors using the PDP
PRINT_CURRENT_MEASURMENTS = True

DRIVETRAIN_LEFT_MOTOR_PDP_CHANNEL = 0
DRIVETRAIN_RIGHT_MOTOR_PDP_CHANNEL = 1
ELEVATOR_PDP_CHANNEL = 14
INTAKE_MOTOR_PDP_CHANNEL = 12
WRIST_MOTOR_PDP_CHANNEL = 5
ClIMBER_MOTOR_PDP_CHANNEL = 3
